...
//            zoomLayoutParams2.height = (Math.abs(newScrollValue) + mHeaderHeight)/3;
//            ViewGroup frameLayout = (ViewGroup) mZoomView;
//                    View view = frameLayout.getChildAt(1);
//            view.setLayoutParams(zoomLayoutParams2);
            FrameLayout frameLayout = (FrameLayout) mZoomView;
            View view = frameLayout.getChildAt(1);
            ViewGroup.LayoutParams zoomLayoutParams2 = view.getLayoutParams();
            zoomLayoutParams2.height = (Math.abs(newScrollValue) + mHeaderHeight)/3;
            zoomLayoutParams2.width = (Math.abs(newScrollValue) + mHeaderHeight)/3;
            view.setLayoutParams(zoomLayoutParams2);
