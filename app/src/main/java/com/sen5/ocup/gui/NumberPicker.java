...
public class NumberPicker extends LinearLayout {
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        // XIE
        float fSize = context.getResources().getDimensionPixelSize(R.dimen.number_text_size);
        mInputText.setTextSize(fSize);
    ...
    public void isEditText(boolean isEditText) {
    	mEditText = isEditText;
    }
