...
import com.sen5.ocup.adapter.FaceAdapter;
import com.sen5.ocup.adapter.ViewPagerAdapter;
...
public class FaceRelativeLayout extends RelativeLayout implements OnItemClickListener, OnClickListener {
	...
	/** 动画表情页界面集合 */
	private ArrayList<View> pageViews_anim;
	...
	private TextView tv_emoji_anim;
	...
	public void onClick(View v) {
		...
		case R.id.et_sendmessage:
			...
			if (view.getVisibility() == View.VISIBLE) {
			 ...
			 mInputMethodManager.showSoftInputFromInputMethod(view.getWindowToken(), InputMethodManager.SHOW_FORCED);
			break;
		// 选择表情
		case R.id.tv_emoji:
	...
	private void Init_View() {
		...
		view_add = findViewById(R.id.inclu_chatadd);

		tv_emoji = (TextView) findViewById(R.id.tv_emoji);
		tv_emoji_anim = (TextView) findViewById(R.id.tv_emoji_anim);
		tv_emoji.setOnClickListener(this);
		tv_emoji_anim.setOnClickListener(this);
