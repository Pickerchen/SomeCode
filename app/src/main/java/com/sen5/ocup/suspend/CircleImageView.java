...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBorderWidth = a.getDimensionPixelSize(R.styleable.CircleImageView2_border_width2, DEFAULT_BORDER_WIDTH);
        mBorderColorStateList = a.getColorStateList(R.styleable.CircleImageView2_border_color2);
