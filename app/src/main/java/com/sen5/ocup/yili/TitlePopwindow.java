...
import com.sen5.ocup.util.PopItemViewHolder;
...
public class TitlePopwindow extends PopupWindow {
    ...
    public TitlePopwindow(Context context, int width, int height) {
    ...
    private void populateActions() {
        ...
        mListView.setAdapter(new BaseAdapter() {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                TextView textView = PopItemViewHolder.get(convertView, R.id.txt_title);
