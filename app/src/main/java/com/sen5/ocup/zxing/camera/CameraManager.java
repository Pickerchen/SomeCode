...
package com.sen5.ocup.zxing.camera;
...
public final class CameraManager {
	...
	private static final float scaleFrame = 6.0f / 10;
	...
	public void setCameraPara(){
		Log.d(TAG, "setCameraPara-------------initialized==" + initialized);
		if (!initialized) {
			initialized = true;
	 ...
	 */
	public Camera openDriver(SurfaceHolder holder) throws IOException {//throws IOException
...
//			} catch (Exception e) {
//				Log.d(TAG, "openDriver-------------Exception  e==" + e);
//			}

			if (camera == null) {
				Log.d(TAG, "openDriver--camera == null");
...
//			} catch (IOException e) {
//				Log.d(TAG, "openDriver--IOException  e=="+e);
//				e.printStackTrace();
//			}
//			Log.d(TAG, "openDriver-------------initialized==" + initialized);
//			if (!initialized) {
//				initialized = true;
//				configManager.initFromCameraParameters(camera);
//			}
...
return camera;
	...
	public synchronized Rect getFramingRect() {
		...
		if (framingRect == null) {
			...
			int black = (int) ((screenResolution.y-Tools.dip2px(context, 60)) * scaleFrame);
			height =  black* 3 / 5;
...
//			topOffset = (int) ((screenResolution.y-Tools.dip2px(context, 60) * scaleFrame - height) / 2);
			topOffset = (black-height)/2;
	...
	public Rect getFramingRectInPreview() {
		if (framingRectInPreview == null) {
			...
			rect.top = rect.top * cameraResolution.x / (screenResolution.y-Tools.dip2px(context, 60));
			rect.bottom = rect.bottom * cameraResolution.x / (screenResolution.y-Tools.dip2px(context, 60));
